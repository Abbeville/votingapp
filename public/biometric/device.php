...
<?php
		...
		if (count($res) > 1) {
			...
			$sql 	= "INSERT INTO devices SET device_name='".$_GET['device_name']."', sn='".$_GET['sn']."', vc='".$_GET['vc']."', ac='".$_GET['ac']."', vkey='".$_GET['vkey']."' ";
		...
		$sql1		= "DELETE FROM devices WHERE sn = '".$_GET['sn']."' ";
