...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{ route('admin.contestant.create') }}"><button class="button text-white bg-theme-1 shadow-md mr-2">Add New Contestants</button></a>
        <div class="hidden md:block mx-auto text-gray-600">Showing 1 to 10 of {{ $contestants->count() }} entries</div>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @forelse($contest as $contestant)
                        ...
                        <tr class="intro-x">
                            <td> 
                                <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ strtoupper($contestant->user->fullname) }} || {{ $contestant->user->level->name }} || {{ $contestant->user->department->short_name}}</div>
                            </td>
